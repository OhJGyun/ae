...
def generate_launch_description():
    """
    Launch MAP Controller OJG Test with Lane Selector integration (FORZA-restored features)

    Launches:
    - map_controller_ojg_test (FORZA features: curvature-based speed limiting, heading adjustment)
